	...
	case MetricsResource:
		slos = rhobSLOList{
			// Observatorium Metrics Availability SLOs.
			{
				...
				successOrErrorsExpr: "http_requests_total{job=\"observatorium-api\", handler=\"receive\", group=\"metricsv1\", code=~\"^5..$\"}",
				totalExpr:           "http_requests_total{job=\"observatorium-api\", handler=\"receive\", group=\"metricsv1\"}",
			...
			// The read availability SLO is split to reflect this deployment topology.
			{
				...
				successOrErrorsExpr: "http_requests_total{job=\"observatorium-api\", handler=\"query\", group=\"metricsv1\", code=~\"^5..$\"}",
				totalExpr:           "http_requests_total{job=\"observatorium-api\", handler=\"query\", group=\"metricsv1\"}",
			...
			},
			{
				...
				successOrErrorsExpr: "http_requests_total{job=\"observatorium-api\", handler=\"query_range\", group=\"metricsv1\", code=~\"^5..$\"}",
				totalExpr:           "http_requests_total{job=\"observatorium-api\", handler=\"query_range\", group=\"metricsv1\"}",
			...
			// Observatorium Metrics Latency SLOs.
			{
				...
				successOrErrorsExpr: "http_request_duration_seconds_bucket{job=\"observatorium-api\", handler=\"receive\", group=\"metricsv1\", code=~\"^2..$\", le=\"" + genericSLOLatencySeconds + "\"}",
				totalExpr:           "http_request_duration_seconds_count{job=\"observatorium-api\", handler=\"receive\", group=\"metricsv1\", code=~\"^2..$\"}",
